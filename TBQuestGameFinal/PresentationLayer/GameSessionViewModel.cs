...
namespace TBQuestGame.PresentationLayer
{
    public class GameSessionViewModel : ObservableObject
    {
        ...
        void OnGameTimerTick(object sender, EventArgs e)
        {
            ...
            MissionTimeDisplay = "Game Timer " + _gameTime.ToString(@"hh\:mm\:ss");
        }
        ...
        private void OnPlayerWins(string message)
        {
            ...
            string titleText = "Your A Winner";
            MessageBoxButton button = MessageBoxButton.YesNo;
            MessageBoxResult result = MessageBox.Show(messagetext, titleText, button);
        ...
        /// <summary>
        /// handle the trade event in the view
        /// </summary>
        public void OnPlayerTrade()
        {
            if (CurrentNpc != null && CurrentNpc is ITrade)
            {
                ITrade tradingNpc = CurrentNpc as ITrade;
                CurrentLocationInformation = tradingNpc.Trade();
            }
        }
        ...
        private void Battle()
        {
            ...
            {
                CurrentLocationInformation = $"{_currentNpc.Name} has no weapon. You feel weaker from making a poor decision like this.";
                _player.ExperiencePoints -= 10;
                if (_player.ExperiencePoints <= -15) OnPlayerDies("You have been killed by bad decisions!");
            }
