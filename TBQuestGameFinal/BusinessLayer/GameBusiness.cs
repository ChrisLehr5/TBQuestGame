    ...
    public class GameBusiness
    {
        ...
        private void SetupPlayer()
        {
            if (_newPlayer)
            {
                ...
                if (_player.PlayStyle == Player.PlayThroughDifficulty.Difficult)
                {
                    _player.Lives = 0;
                    _player.Health = 50;
                    _player.SkillLevel = 2;
                }
                else if (_player.PlayStyle == Player.PlayThroughDifficulty.Normal)
                {
                    _player.Lives = 2;
                    _player.Health = 75;
                    _player.SkillLevel = 3;
                }
                else
                {
                    _player.Lives = 3;
