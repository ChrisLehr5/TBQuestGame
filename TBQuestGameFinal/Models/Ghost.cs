...
namespace TBQuestGame.Models
{
    public class Ghost : Npc, ISpeak, IBattle, ITrade
    {
        ...
        /// <summary>
        /// generate a trade message or use default
        /// </summary>
        /// <returns>message text</returns>
        public string Trade()
        {
        ...
        /// <summary>
        /// randomly select a trade message from the list of messages
        /// </summary>
        /// <returns>message text</returns>
        private string GetBarter()
        {
            Random r = new Random();
            int messageIndex = r.Next(0, Barter.Count());
            return Barter[messageIndex];
        }
